...
{
	public class SignTaskProcess: AbstractTaskHandler, ISignTaskProcess
	{
		private ITaskSignerRepository taskSignerRepository;

		public SignTaskProcess()
		{
		...
		{
			taskSignerRepository.UpdateSigningStatus(taskId, userId, SigningStatus.Підписано);
		}
	}
}